...
// 本文件改编自：
// https://github.com/archibate/co_async/blob/master/steps/co_async/rbtree.hpp
//
// 原项目：archibate/co_async
// 原作者：archibate
//
// 本仓库修改：Lizhijie, 2026
//
// 注意：引入时上游文件未包含单文件版权声明；在再次分发前，
// 需要确认上游仓库许可证条款。
...
template <class Value, class Compare = std::less<Value>> struct RbTree {
...
public:
  ...
  template <class Visitor> void traversalInorder(Visitor &&visitor) {
